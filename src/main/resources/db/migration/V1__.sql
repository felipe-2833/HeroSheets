...
ALTER TABLE atributo
    ADD CONSTRAINT FK_ATRIBUTO_ON_SISTEMA FOREIGN KEY (sistema_id) REFERENCES sistema (id);
...
ALTER TABLE habilidade
    ADD CONSTRAINT FK_HABILIDADE_ON_SISTEMA FOREIGN KEY (sistema_id) REFERENCES sistema (id);

ALTER TABLE item
    ADD CONSTRAINT FK_ITEM_ON_SISTEMA FOREIGN KEY (sistema_id) REFERENCES sistema (id);
